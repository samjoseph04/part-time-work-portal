...
const EmployerFeedback = () => {
  ...
  const fetchWorkDetails = async (executionId) => {
    try {
      ...
      console.log("Fetching work details for executionId:", executionId, "with token:", token);
      ...
      console.log("Work details response:", response.data);
      setApplicantId(response.data.applicant_id);
      setEmpId(response.data.emp_id); // Set empId from API response
  ...
  const handleSubmitFeedback = async (e) => {
    ...
    if (!executionId || !applicantId || !empId || !token) {
          ...
          <form onSubmit={handleSubmitFeedback} className="feedback-form">
            ...
            <div className="form-group">
              ...
              <textarea
                ...
                placeholder="Share your feedback about the applicant's work..."
                rows={5}
